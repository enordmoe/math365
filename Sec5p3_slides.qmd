...
-   Think about how to describe the way a **statistic** (like the sample
...
##  {.smaller}
### K Coffee Habits: Tabular Sampling Distribution

```{r}
x <- 0:10
data.frame(x = x, p_hat = x/10, prob = dbinom(x, 10, 0.30))
```  

##  {.smaller}
### K Coffee Habits: Graphical Sampling Distribution  

```{r}
barplot(dbinom(x, 10, 0.30), names.arg = x/10, col = "orange")
```
...
## {.smaller}
### 📝 Summary: Statistics and Their Distributions
