...
- **Measurement**: Time (in seconds, to the nearest tenth) each student
  was able to balance.
- **Purpose**: Use our own class data to explore measures of center,
  spread, and distributional shape.
...
::: notes
This is a natural dataset for comparing groups: three manufacturers give
us three subgroups to summarize side by side. We'll use it to motivate overall analysis and then with 
both measures of center/spread and tools like side-by-side boxplots.
:::
