...
Today, you'll compare two classic approaches: - **Wald Interval**: $$
...
Let’s simulate 1000 samples of size $n = 20$ from a Bernoulli($p = 0.1$) distribution.
...
Not all combinations of sample size $n$ and true proportion $p$ are created equal when it comes to confidence intervals. 📉
