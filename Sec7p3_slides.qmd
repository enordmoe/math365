...
1.  Complete the Reaction Test Applet task in the applets section on
    Moodle:

::: fragment
2.  Submit your times here: <https://forms.office.com/r/UyaDXQKm3K>

![](images/clipboard-2644788912.png){width="400"}
:::
...
:white_check_mark: Critical value larger than $z$ or $t$ values for
CIs.\
...
-   TI captures a fixed proportion of the population, not just the mean
    or a single value.
